...
export default function TeacherProgressTable({ 
  students, 
  totalResources,
  classGroup = "A" 
}: TeacherProgressTableProps) {
  return (
    <div className="card-soft p-6 border-2 border-green-500/20 mt-8 animate-in fade-in duration-300">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900">
            Tabel Progres Belajar Siswa {classGroup ? `(Kelas 6${classGroup})` : ""}
          </h2>
          <p className="text-sm text-gray-500">
            Pantau perkembangan siswa dalam menyelesaikan materi E-Learning.
          </p>
        </div>
      </div>
            ...
            {students.length === 0 ? (
              <tr>
                <td colSpan={5} className="py-8 text-center text-gray-500 font-medium">
                  Belum ada data siswa di Kelas 6{classGroup}.
                </td>
              </tr>
            ) : (
